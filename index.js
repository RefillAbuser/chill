...
client.on('message', message => {
  ...
  if (message.content.includes("fuck")) {
      message.delete();
      message.reply(" foul language is not aloud.");
  }
  ...
  if (message.content.includes("negger")) {
      message.delete();
      message.reply(" foul language is not aloud.");
  }
  ...
  if (message.content.includes("triggerd")) {
      message.delete();
      message.reply(" Lol stop being such a scrub?");
  }
    
  if (message.content.includes("bitch")) {
      message.delete();
      message.reply(" I know you are. But what am i?");
  }
    //chat bot
